...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '豫ICP备16006040号',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  '1352726123@qq.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '七七博客',             //网站名：
    'WEB_KEYWORDS'              =>  '赵贤,七七,技术博客,个人博客,zqiqiblog',         //网站关键字
    'WEB_DESCRIPTION'           =>  '赵贤的个人技术博客,zqiqiblog官方网站',      //网站描述
    'AUTHOR'                    =>  '七七',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为赵贤原创文章,转载无需和我联系,但请注明来自赵贤博客zqiqi.cn',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  '赵七七博客', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'zqiqi.cn',      //文字水印内容
