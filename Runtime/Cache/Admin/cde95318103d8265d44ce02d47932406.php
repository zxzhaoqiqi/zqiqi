    ...
    <body>
        <form action="<?php echo U('Admin/Config/index');?>" method="post">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="javascript:;" data-toggle="tab">网站设置</a>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="tab">优化推广</a>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="tab">文章水印</a>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="tab">第三方登录</a>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="tab">其他第三方接口</a>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="tab">邮箱设置</a>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="tab">评论设置</a>
                </li>
            </ul>
            ...
            <script type="text/javascript">
                $('.nav-tabs li').click(function(){
                    ...
                    $('.tab-pane').eq(num).addClass('active').siblings('.tab-pane').removeClass('active');
                })
            </script>
        </form>
    </body>
