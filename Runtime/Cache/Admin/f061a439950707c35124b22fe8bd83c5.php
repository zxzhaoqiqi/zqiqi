...
<html>
  ...
  <body>
    <form method="post" enctype="multipart/form-data" onsubmit="return hd_submit(this,'<?php echo U('Admin/Link/edit');?>','<?php echo U('Admin/Link/index');?>')">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="hidden" value="<?php echo ($oldData['lid']); ?>"  name="lid">
      </div>
